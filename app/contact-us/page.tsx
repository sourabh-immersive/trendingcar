            ...
            <section className="sitemap-layout">
                <div className="container">
                    <div className="row single-content-area">
                        ...
                        <p style={{ textAlign: 'center' }}>Got questions or feedback about our car reviews, comparisons, or latest news? <br />Reach out to us! We’re here to help and would love to hear from you.</p>
